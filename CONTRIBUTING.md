...
* [Submit a post for your issue](https://github.com/NPTfisheries/SnakeR_IPTDS/issues/), assuming one does not already exist.
...
* If you need help or unsure about anything, post an update to [your issue](https://github.com/NPTfisheries/SnakeR_IPTDS/issues/).

## Submitting your changes

Push to your fork and [submit a pull request](https://github.com/NPTfisheries/SnakeR_IPTDS/compare/).
...
* Engage in discussion on [your issue](https://github.com/NPTfisheries/SnakeR_IPTDS/issues/).
